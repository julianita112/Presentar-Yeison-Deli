        ...
        <div className="w-full lg:w-1/2 mt-">
          <Card className="p-12 shadow-xl rounded-lg bg-white">
            ...
            <form className="mt-8" onSubmit={step === 1 ? handleSendEmail : handleResetPassword}>
             ...
             <Button type="submit" className="btncanceregistro" color="green" size="sm"// Clase personalizada y ajusta el padding
    onClick={() => navigate("/auth/sign-in")}
  >
    Cancelar
  </Button>
  <Button type="submit" className="btnagregar" color="green" size="sm">
